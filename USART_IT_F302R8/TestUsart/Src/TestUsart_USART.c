 ...
 */
#include "TestUsart.h"
#include "TestUsart_USART.h"
extern void** TestUsart_block_outtbptr; //External array definition of output pointers for blocks 
...
void USART_Initialize(void){
   TestUsart_block_outtbptr[2] = (uint16_t*)&USART2_RxDataLink.nbRcv; //Set first output block pointer
   TestUsart_block_outtbptr[3] = (uint8_t*)&USART2_RxDataLink.ptRcv; //Set second output block pointer
   USART2_Rx_Initialization(); //Initialize USART2 to receive
   TestUsart_block_outtbptr[4] = (uint16_t*)&USART2_TxDataLink.nbSent; //Set output block pointer
